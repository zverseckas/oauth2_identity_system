defmodule EevalWeb.UserControllerTest do
  use EevalWeb.ConnCase

  alias Eeval.Accounts
  alias Eeval.Accounts.User

  @create_attrs %{email: "some email", first_name: "some first_name", last_name: "some last_name", password_hash: "some password_hash", username: "some username"}
